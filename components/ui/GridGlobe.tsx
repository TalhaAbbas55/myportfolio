...
// three.js + three-globe + @react-three/drei are by far the heaviest dependency
// in the project. Loading is deferred until the globe is actually near the
// viewport (see the IntersectionObserver below) rather than on mount.
...
// Colours were previously picked with Math.random() inside the render body,
// which produced different markup on the server and the client (a hydration
// mismatch) and re-randomised on every re-render. Indexing keeps it stable.
const SAMPLE_ARCS: Arc[] = ARCS.map((arc, i) => ({
  ...arc,
  ...
  return (
    ...
    <div className="flex items-center justify-center absolute -left-5 top-36 md:top-36 w-full h-full">
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-96 px-4">
        ...
        {/* remove -bottom-20 */}
        <div ref={containerRef} className="absolute w-full h-72 md:h-full z-10">
          {shouldRender && (
